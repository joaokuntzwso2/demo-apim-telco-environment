...
log \
  "Applied application_access_token_expiry_time=2 through the APIM key-mapping API."
...
then
  ...
  fail \
    "APIM did not persist application_access_token_expiry_time=2."
fi

log \
  "APIM reports application_access_token_expiry_time=2 for the OAuth client."
