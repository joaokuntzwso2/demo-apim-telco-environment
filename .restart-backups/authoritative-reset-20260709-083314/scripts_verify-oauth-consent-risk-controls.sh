...
# application's configured/default lifetime. The OAuth client's application access-token lifetime is reconciled to two seconds.
# Request the token directly and verify the persisted client configuration.
#
...
PY_CREDENTIALS
  ...
  then
    ...
    short_token_url="${OAUTH_SHORT_TOKEN_URL:-https://127.0.0.1:9443/oauth2/token}"
