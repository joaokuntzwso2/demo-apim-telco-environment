...
if (
    "application_access_token_expiry_time: 2" in text
    and "user_access_token_expiry_time: 2" in text
):
    print(
        "[final-oauth-logic] "
    ...
    replacement = '''validityTime: 2,
      additionalProperties: JSON.stringify({
        application_access_token_expiry_time: 2,
        user_access_token_expiry_time: 2
      })'''
    ...
    print(
        "[final-oauth-logic] "
        "Added application_access_token_expiry_time=2 to the "
